        ...
        <div class="login float-end">
            ...
            <div class="login-form">
                <form action="includes/log_in.php" method="POST">
                    ...
                    <!-- <p class="subtext" style="color: #e5e5e2;">don't have an account? <span style="color: #0d6efd; text-decoration: underline;"><a href="register.php">Sign Up Now</a> to join the movement</span></p> -->

                    <a href="register.php"><button type="button" class="btn1 btn-outline-secondary">Register Now</button></a>
                </form>
            </div>
        </div>
    </div>
