...
if(isset($_GET['update'])){
	...
	if($edit_post_title== '' || $edit_post_desc== ''){
		...
		mysqli_query($conn,"UPDATE user_post SET `post_title`='".$edit_post_title."',`post_content`='".$edit_post_desc."',post_image='$edit_post_image',`content_prompt`='".$contentprompt."',`image_prompt`='".$imageprompt."' ,`content_ai`='".$toolcontent."' ,`image_ai`='".$toolimage."' WHERE id='$update_id'");
