	...
	$post_id = $post_tukra['id']; ?>
        <form action="./includes/edit.php?update=<?php echo $post_id; ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="input-box">
                ...
                <input type="text" name="edit-post-title" id="edit-post-title" placeholder="Enter post title" style="width: 100%" value="<?php echo $post_tukra['post_title']; ?>" readonly/>
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
                        ...
                        <input type="text" name="contentprompt" id="contentprompt" value="<?php echo $post_tukra['content_prompt']; ?>"
                            style="width: 100%">
                    </div>
                    <div class="input-box">
                        <label for="postpromptimage">Prompt for Image</label>
                        <input type="text" name="imageprompt" id="imageprompt"  value="<?php echo $post_tukra['image_prompt']; ?>"
                            style="width: 100%">
                    </div>
                    <div class="input-box">
                        <label for="aiToolContent">AI Tool for content</label>
                        <input type="text" name="toolcontent" id="toolcontent" value="<?php echo $post_tukra['content_ai']; ?>"
                            style="width: 100%">
                    </div>
                    <div class="input-box">
                        <label for="aiToolImage">AI Tool for Image</label>
                        <input type="text" name="toolimage" id="toolimage" value="<?php echo $post_tukra['image_ai']; ?>"
                            style="width: 100%">
                    </div>
